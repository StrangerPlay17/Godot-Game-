...
func _on_body_entered(body: Node2D) -> void:  # Función al tocar la bandera
	if body.get_name() == "Player1" or body.get_name() == "Player2" or body.get_name() == "Player1" and body.get_name() == "Player2": # Valida si la moneda fue tocada por el jugador 1 o 2
